(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@stacks/connect')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@stacks/connect'], factory) :
  (global = global || self, factory(global['@stacks/connect-react'] = {}, global.React, global.connect));
}(this, (function (exports, React, connect) { 'use strict';
  ...
  var useConnect = function useConnect() {
    ...
    function doProfileUpdate(options) {
      return connect.openProfileUpdateRequestPopup(_extends({}, options, {
        authOrigin: authOptions.authOrigin,
        appDetails: authOptions.appDetails
      }));
    }
...
//# sourceMappingURL=connect-react.umd.development.js.map
