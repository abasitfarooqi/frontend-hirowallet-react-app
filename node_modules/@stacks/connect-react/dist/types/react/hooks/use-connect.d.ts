import { AuthOptions, ContractCallOptions, ContractCallRegularOptions, ContractCallSponsoredOptions, ContractDeployOptions, ContractDeployRegularOptions, ContractDeploySponsoredOptions, FinishedAuthData, ProfileUpdateRequestOptions, SignatureRequestOptions, STXTransferOptions, STXTransferRegularOptions, STXTransferSponsoredOptions } from '@stacks/connect';
...
export declare const useConnect: () => {
    ...
    doOpenAuth: (signIn?: boolean, options?: Partial<AuthOptions>) => void;
    ...
    doProfileUpdate: (options: ProfileUpdateRequestOptions) => Promise<void>;
